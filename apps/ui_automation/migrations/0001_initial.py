# Generated by Django 4.2.7 on 2026-01-13 13:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "task_description",
                    models.TextField(help_text="自然语言任务描述", verbose_name="任务描述"),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "gif_path",
                    models.CharField(
                        blank=True, max_length=500, null=True, verbose_name="GIF录制路径"
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "page",
                    models.CharField(blank=True, max_length=200, verbose_name="所属页面"),
                ),
                (
                    "component_name",
                    models.CharField(
                ...
                (
                    "usage_count",
                    models.IntegerField(
                        default=0, help_text="在脚本中被引用的次数", verbose_name="使用次数"
                    ),
                ),
                (
                    "last_validated",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "template_code",
                    models.TextField(
                        blank=True, help_text="生成的页面对象代码模板", verbose_name="模板代码"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "method_name",
                    models.CharField(
                        help_text="在页面对象中的方法/属性名称", max_length=100, verbose_name="方法名称"
                    ),
                ),
                (
                    "is_property",
                    models.BooleanField(
                        default=True, help_text="True为属性，False为方法", verbose_name="是否为属性"
                    ),
                ),
                ("order", models.IntegerField(default=0, verbose_name="排序")),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(upload_to="ui_screenshots/", verbose_name="截图文件"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "line_number",
                    models.IntegerField(help_text="在脚本中的行号", verbose_name="行号"),
                ),
                (
                    "context",
                    models.TextField(
                        blank=True, help_text="使用元素的代码上下文", verbose_name="上下文代码"
                    ),
                ),
                (
                    "frequency",
                    models.IntegerField(
                        default=1, help_text="在脚本中使用的次数", verbose_name="使用频次"
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expected_result",
                    models.CharField(blank=True, max_length=500, verbose_name="预期结果"),
                ),
                (
                    "wait_before",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "browser_version",
                    models.CharField(blank=True, max_length=50, verbose_name="浏览器版本"),
                ),
                (
                    "resolution",
                    models.CharField(blank=True, max_length=50, verbose_name="屏幕分辨率"),
                ),
                (
                    "os_type",
                ...
                (
                    "capabilities",
                    models.JSONField(blank=True, null=True, verbose_name="浏览器能力配置"),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="创建时间"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "result_data",
                    models.JSONField(blank=True, null=True, verbose_name="执行结果数据"),
                ),
                ("error_message", models.TextField(blank=True, verbose_name="错误信息")),
                (
                    "report_url",
                    models.CharField(blank=True, max_length=500, verbose_name="报告URL"),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="创建时间"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "task_type",
                    models.CharField(
                        choices=[("TEST_SUITE", "测试套件执行"), ("TEST_CASE", "测试用例执行")],
                        max_length=20,
                        verbose_name="任务类型",
                    ),
                ),
                ...
                (
                    "notify_emails",
                    models.JSONField(blank=True, default=list, verbose_name="通知邮箱列表"),
                ),
                (
                    "status",
                    models.CharField(
