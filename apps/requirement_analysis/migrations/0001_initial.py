    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "prompt_type",
                    models.CharField(
                        choices=[("writer", "用例编写提示词"), ("reviewer", "用例评审提示词")],
                        max_length=20,
                        verbose_name="提示词类型",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "analysis_time",
                    models.FloatField(blank=True, null=True, verbose_name="分析耗时(秒)"),
                ),
                (
                    "created_at",
                    models.DateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "saved_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="保存到记录时间"),
                ),
            ],
            options={
