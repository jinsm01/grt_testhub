...
export function getDashboardStats() {
  return request({
    url: '/api/api-testing/dashboard/stats/',
    method: 'get'
  })
}
...
export function getScheduledTasks(params) {
  return request({
    url: '/api/api-testing/scheduled-tasks/',
    method: 'get',
    params
  })
}
...
export function updateScheduledTask(id, data) {
  return request({
    url: `/api/api-testing/scheduled-tasks/${id}/`,
    method: 'patch',
    data
  })
}
...
export function runScheduledTask(id) {
  return request({
    url: `/api/api-testing/scheduled-tasks/${id}/run_now/`,
    method: 'post'
  })
}
...
export function getExecutionLogs(taskId, params = {}) {
  return request({
    url: `/api/api-testing/scheduled-tasks/${taskId}/execution_logs/`,
    method: 'get',
    params
  })
}
...
export function getTestSuites(params) {
  return request({
    url: '/api/api-testing/test-suites/',
    method: 'get',
    params
  })
}
...
export function getEnvironments(params) {
  return request({
    url: '/api/api-testing/environments/',
    method: 'get',
    params
  })
}
...
export function getApiCollections(params) {
  return request({
    url: '/api/api-testing/collections/',
    method: 'get',
    params
  })
}
...
export function executeTestSuite(id, data) {
  return request({
    url: `/api/api-testing/test-suites/${id}/execute/`,
    method: 'post',
    data
  })
}
...
export function executeApiRequest(id, data) {
  return request({
    url: `/api/api-testing/api-requests/${id}/execute/`,
    method: 'post',
    data
  })
}
...
export function getExecutionResult(id) {
  return request({
    url: `/api/api-testing/executions/${id}/`,
    method: 'get'
  })
}
...
export function deleteRequestHistory(id) {
  return request({
    url: `/api/api-testing/histories/${id}/`,
    method: 'delete'
  })
}
...
export function batchDeleteRequestHistory(ids) {
  return request({
    url: '/api/api-testing/histories/batch-delete/',
    method: 'post',
    data: { ids }
  })
}
...
export function getOperationLogs(params) {
  return request({
    url: '/api/api-testing/operation-logs/',
    method: 'get',
    params
  })
}
