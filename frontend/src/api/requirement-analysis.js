...
export function getActiveAIModelConfig(modelType, role) {
  return request({
    url: '/api/requirement-analysis/ai-models/active/',
    method: 'get',
...
export function updateAIModelConfig(id, data) {
  return request({
    url: `/api/requirement-analysis/ai-models/${id}/`,
    method: 'put',
    data
  })
}
...
export function getPromptConfigs(params) {
  return request({
    url: '/api/requirement-analysis/prompts/',
    method: 'get',
    params
  })
}
...
export function getActivePromptConfig(promptType) {
  return request({
    url: '/api/requirement-analysis/prompts/active/',
    method: 'get',
...
export function updatePromptConfig(id, data) {
  return request({
    url: `/api/requirement-analysis/prompts/${id}/`,
    method: 'put',
    data
  })
}
