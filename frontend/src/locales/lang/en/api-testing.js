...
export default {
  ...
  component: {
    keyValueEditor: {
      ...
      variables: {
        ...
        // Professional tools
        scienceChemicalElement: 'Random chemical element',
        scienceChemicalSymbol: 'Random chemical element symbol',
        scienceChemicalName: 'Random chemical element name',
        scienceUnit: 'Random scientific unit',
        airlineName: 'Random airline name',
        airlineIataCode: 'Random airline IATA code',
        airlineAirport: 'Random airport info',
        airlineAirportName: 'Random airport name',
        airlineAirportIataCode: 'Random airport IATA code',
        airlineAircraftType: 'Random aircraft type',
        vehicleManufacturer: 'Random vehicle manufacturer',
        vehicleModel: 'Random vehicle model',
        vehicleType: 'Random vehicle type',
        vehicleFuelType: 'Random fuel type',
        databaseType: 'Random database type',
        databaseColumn: 'Random database column',
        databaseEngine: 'Random database engine',
        // System tools
        gitBranch: 'Random Git branch name',
        gitCommitMessage: 'Random Git commit message',
        gitCommitSha: 'Random Git commit SHA',
        gitShortCommitSha: 'Random short Git commit SHA',
        systemFileName: 'Random file name',
        systemFileExt: 'Random file extension',
        systemDirectoryPath: 'Random directory path',
        systemFilePath: 'Random file path',
        systemMimeType: 'Random MIME type',
        systemSemver: 'Random semantic version',
        systemPlatform: 'Random platform name',
        systemArch: 'Random system architecture',
        // Entertainment tools
        musicGenre: 'Random music genre',
        musicSongName: 'Random song name',
        musicArtist: 'Random artist name',
        animalType: 'Random animal type',
        animalName: 'Random animal name',
        foodDish: 'Random dish name',
        foodIngredient: 'Random ingredient',
        foodFruit: 'Random fruit',
        foodVegetable: 'Random vegetable',
        // Mock images
        imageUrl: 'Random image URL',
        imageAvatar: 'Random avatar URL',
        imagePlaceholder: 'Generate placeholder image URL',
  ...
  messages: {
    ...
    error: {
      executeSuite: 'Failed to execute suite',
