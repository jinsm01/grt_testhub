...
export default {
  ...
  interface: {
    ...
    addExtractor: '添加提取规则',
    extractorTips: '从响应中提取数据并保存到环境变量，供后续接口使用',
    extractorName: '提取规则名称',
    selectSource: '选择提取来源',
    jsonBody: '响应体 (JSON)',
    responseHeader: '响应头',
    jsonPathPlaceholder: 'JSON Path 表达式，如: $.data.token',
    headerNamePlaceholder: '响应头名称，如: X-Auth-Token',
    variableNamePlaceholder: '环境变量名称，如: authToken',
    noExtractors: '暂无变量提取规则',
    addFirstExtractor: '添加第一个提取规则',
    response: '响应',
    responseBody: '响应体',
    responseHeaders: '响应头',
    format: '格式化',
    selectCollection: '选择所属集合',
    // Body 类型
    paramName: '参数名',
    paramValue: '参数值',
    headerName: 'Header名',
  ...
  component: {
    keyValueEditor: {
      ...
      variables: {
        ...
        // 专业工具
        scienceChemicalElement: '随机化学元素',
        scienceChemicalSymbol: '随机化学元素符号',
        scienceChemicalName: '随机化学元素名称',
        scienceUnit: '随机科学单位',
        airlineName: '随机航空公司',
        airlineIataCode: '随机航司IATA代码',
        airlineAirport: '随机机场信息',
        airlineAirportName: '随机机场名称',
        airlineAirportIataCode: '随机机场IATA代码',
        airlineAircraftType: '随机机型',
        vehicleManufacturer: '随机车辆制造商',
        vehicleModel: '随机车辆型号',
        vehicleType: '随机车辆类型',
        vehicleFuelType: '随机燃料类型',
        databaseType: '随机数据库类型',
        databaseColumn: '随机数据库列名',
        databaseEngine: '随机数据库引擎',
        // 系统工具
        gitBranch: '随机Git分支名',
        gitCommitMessage: '随机Git提交信息',
        gitCommitSha: '随机Git Commit SHA',
        gitShortCommitSha: '随机短Commit SHA',
        systemFileName: '随机文件名',
        systemFileExt: '随机文件扩展名',
        systemDirectoryPath: '随机目录路径',
        systemFilePath: '随机文件路径',
        systemMimeType: '随机MIME类型',
        systemSemver: '随机语义化版本号',
        systemPlatform: '随机平台名',
        systemArch: '随机系统架构',
        // 娱乐工具
        musicGenre: '随机音乐类型',
        musicSongName: '随机歌曲名',
