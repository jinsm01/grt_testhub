...
.notification-tabs :deep(.el-tabs__item:hover) {
  color: #5a32a3;
  background: rgba(90, 50, 163, 0.08);
}

.notification-tabs :deep(.el-tabs__item.is-active) {
  color: #5a32a3 !important;
  background: white;
  border-bottom: 2px solid #5a32a3 !important;
}
...
/* 启用开关样式 - 紫色渐变主题 */
.notification-configs-container :deep(.el-switch__core) {
  background-color: #dcdfe6 !important;
  border-color: #dcdfe6 !important;
}

.notification-configs-container :deep(.el-switch__action) {
  background-color: #ffffff !important;
}

.notification-configs-container :deep(.el-switch.is-checked .el-switch__core) {
  background: linear-gradient(135deg, #5a32a3 0%, #7b42f6 100%) !important;
  border-color: #5a32a3 !important;
}

.notification-configs-container :deep(.el-switch.is-checked .el-switch__action) {
  background-color: #ffffff !important;
}
